...
Call log:
  - waiting for getByRole('button', { name: /continuar|log ?in|entrar/i })
    - locator resolved to <button type="submit" class="pf-c-button pf-m-primary pf-m-block">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <ak-loading-overlay theme="light"></ak-loading-overlay> intercepts pointer events
      ...
      - generic [ref=e18]:
        - banner "User information" [ref=e19]:
          ...
          - link "Not you?" [ref=e25] [cursor=pointer]:
            - /url: /flows/-/cancel/?next=%2Fapplication%2Fo%2Fauthorize%2F%3Fresponse_type%3Dcode%26client_id%3Dbff-web%26scope%3Dopenid%2520email%2520profile%2520offline_access%2520vinculos%26state%3DXfaE0zT_3hqjcDxWZHE9lVnapPuMrZ8such0gxgk3qw%253D%26redirect_uri%3Dhttp%3A%2F%2Flocalhost%3A4200%2Flogin%2Foauth2%2Fcode%2Fauthentik%26nonce%3DEORgtE82spmW2rtZHEInfIyUyOFM0zJhNHV8TObzryk
        - generic [ref=e26]:
